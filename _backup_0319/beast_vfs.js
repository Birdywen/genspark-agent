...
async function handle(tool, params, ctx) {
  ...
  switch(tool) {
    ...
    case 'vfs_save': {
      ...
      const saveName = params.key ? (params.slot + ':' + params.key) : params.slot;
...
export default {
  name: 'vfs',
  tools: ['vfs_read', 'vfs_write', 'vfs_delete', 'vfs_list', 'vfs_query', 'vfs_search', 'vfs_exec', 'vfs_backup', 'vfs_genspark_write', 'vfs_genspark_read', 'vfs_local_write', 'vfs_local_read', 'vfs_save'],
